...
const Blogs = () => {
    return (
        <div className='container mx-auto bg-slate-50 p-6 my-10 rounded'>
            <Helmet>
                <title>Viva-visa - blogs</title>
            </Helmet>
            <div>
                <h1 className="font-semibold lg:text-4xl md:text-3xl text-2xl my-8">Question 1: What are the difference between SQL and NoSQL?</h1>
                <div className='flex w-full lg:flex-row md:flex-row flex-col'>
                    <div className='lg:w-1/2 sm:w-full'>
                        <h3 className='lg:text-3xl md:text-2xl text-xl text-center'>What is SQL?</h3>
                    ...
                    <div className='lg:w-1/2 sm:w-full'>
                        <h3 className='lg:text-3xl md:text-2xl text-xl text-center'>What is NoSQL?</h3>
                        <p className='p-8'>
            ...
            <div>
                <h1 className="font-semibold lg:text-4xl md:text-3xl text-2xl md:my-8">Question 2: What is JWT, and how does it work?</h1>
                <div className='p-8'>
                    <h3 className='lg:text-3xl md:text-2xl text-xl md:my-5 my-2'>What is JWT?</h3>
                    <p>JWT, or JSON Web Token, is an open standard used to share security information between two parties — a client and a server. Each JWT contains encoded JSON objects, including a set of claims. JWTs are signed using a cryptographic algorithm to ensure that the claims cannot be altered after the token is issued.</p>
                    <h3 className='lg:text-3xl md:text-2xl text-xl md:my-5 my-2'>How it work?</h3>
            ...
            <div>
                <h1 className="font-semibold lg:text-4xl md:text-3xl text-2xl md:my-8">Question 3: What is the difference between javascript and NodeJS?</h1>
                <div className='flex w-full lg:flex-row md:flex-row flex-col'>
                    <div className='lg:w-1/2 md:w-1/2 w-full'>
                        <h3 className='lg:text-3xl md:text-2xl text-xl text-center mt-2'>Javascript</h3>
                        <p className='p-8'>
                    ...
                    <div className='lg:w-1/2 md:w-1/2 w-full'>
                        <h3 className='lg:text-3xl md:text-2xl text-xl text-center'>NodeJS</h3>
                        <p className='p-8'>
            ...
            <div className='mb-10'>
                <h1 className="font-semibold lg:text-4xl md:text-3xl text-2xl md:my-8">Question 4: How does NodeJS handle multiple requests at the same time?</h1>
                <div className='p-8'>
