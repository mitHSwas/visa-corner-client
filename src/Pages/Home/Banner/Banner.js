            ...
            <div className="carousel w-full">
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="absolute justify-start transform -translate-y-1/2 left-10 top-1/4">
                        <h1 className="lg:text-5xl md:text-4xl text-2xl text-white font-bold w-5/6 mt-14 lg:my-8">Visa Corner is Global Immigration Consultants Ltd.</h1>
                        <p className="lg:text-xl lg:block md:block hidden text-white font-semibold w-3/5">You are presumed to know the law or procedures system, but it is likely you will not be aware of every factor that may affect your case.</p>
                        <br />
